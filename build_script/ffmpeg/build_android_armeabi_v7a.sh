...
if ! performBuild "$1"; then
    export NEON_CONFIG="--disable-neon"
    echo "### ARMv7-a NEON build failed, trying without NEON support ###"
    performBuild "$1"
    echo "### ARMv7-a Build without NEON support completed ###"
fi
